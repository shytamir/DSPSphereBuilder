...
contract; the [archived feasibility roadmap](archive/ROADMAP-feasibility-and-mvp-definition.md)
and [findings](../FEASIBILITY.md) supply its provenance. Publishing this draft
neither executes its stories nor accepts a future executable build.
